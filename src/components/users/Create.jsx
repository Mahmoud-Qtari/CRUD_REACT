            ...
            <div className="row flex-nowrap">
                ...
                <div classname="col py-3">
                    ...
                    <form onSubmit={()=>sendData(event)}>
                        <Input errors={error} id='name' title='User Name' type='text' name='name' changeData={changeData} />
                        {}
                        <Input errors={error} id='email' title='User Email' type='email' name='email' changeData={changeData} />
                        {}
                        <Input errors={error} id='password' title='User Password' type='password' name='password' changeData={changeData} customeClass='bg-danger' />
                        {}
                        <div className="mb-3">
